<x-layout>
  ...
  <main class="grid min-h-full place-items-center bg-transparent px-6 lg:px-8">
      <div class="text-center py-32 sm:py-36">
        <p class="pt-24 text-base font-semibold text-indigo-600">404</p>
